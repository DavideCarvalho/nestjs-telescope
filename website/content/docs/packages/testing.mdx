---
title: "@dudousxd/nestjs-telescope-testing"
description: Test utilities — a deterministic FakeClock, a no-NestJS watcher harness, and the in-memory storage provider re-exported for tests.
---
...
Test utilities for Telescope: a deterministic clock, a watcher harness that needs no NestJS app, and the in-memory store re-exported so tests need one import.
