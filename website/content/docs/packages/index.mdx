...
| `@dudousxd/nestjs-telescope-observe` | Forward entries to NestJS Observe (hosted). |
...
<Cards>
  ...
  <Card title="NestJS Observe (-observe)" href="/docs/packages/observe" description="Report what Telescope captures into a hosted Observe project." />
