---
title: Packages
description: The full suite — core, the dashboard, watchers, storage adapters, queue managers, the OpenTelemetry bridge, and test utilities. Install only what your stack needs.
---
