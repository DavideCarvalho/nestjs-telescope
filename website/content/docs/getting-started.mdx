...
- **Node.js 20+**
- **NestJS 11+** for the UI module, 12 included (core works on 10+)
...
- [MCP server](/docs/concepts/mcp) — connect Claude Code / Cursor and debug straight from captured data
- [Configuration reference](/docs/reference/configuration) — every `forRoot()` option in one table
