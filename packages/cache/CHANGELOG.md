...
- [#37](https://github.com/DavideCarvalho/nestjs-telescope/pull/37) [`3969c33`](https://github.com/DavideCarvalho/nestjs-telescope/commit/3969c338dd6c360fb08bb68e6b279f06cdf7ab77) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Add `bentoCacheSource(emitter)`, a ready-made `CustomCacheSource` for
...
- [`d72bdf7`](https://github.com/DavideCarvalho/nestjs-telescope/commit/d72bdf70bece2f01637e48bba222e4a6ab114ff5) - Lazy-import `@nestjs/cache-manager` so Bento-only consumers don't need the optional peer.
...
- [`60a32ef`](https://github.com/DavideCarvalho/nestjs-telescope/commit/60a32ef1720a0ce90744d280df9c9a925281e730) - Add zero-config auto-discovery to `CacheWatcher`. `new CacheWatcher()` (no args)
...
- [`ec61797`](https://github.com/DavideCarvalho/nestjs-telescope/commit/ec61797bf76a96e34048713e7e36d020361372c9) - Add a custom cache instrumentation path to `CacheWatcher`. The constructor now
