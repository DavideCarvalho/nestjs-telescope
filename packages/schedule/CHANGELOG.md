...
- [#87](https://github.com/DavideCarvalho/nestjs-telescope/pull/87) [`643534b`](https://github.com/DavideCarvalho/nestjs-telescope/commit/643534b8bc980e78ce8f13614a9d534d67c72da7) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Fix a silent, total instrumentation failure: BullMQ jobs and `@nestjs/schedule` runs were never captured in a real app.
...
- [`54f9f1e`](https://github.com/DavideCarvalho/nestjs-telescope/commit/54f9f1e0b45a558c32ef24ed743382d2be28cd41) - Add the schedule watcher (`@dudousxd/nestjs-telescope-schedule`).
