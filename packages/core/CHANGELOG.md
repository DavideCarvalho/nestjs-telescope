...
- [`8d9f88f`](https://github.com/DavideCarvalho/nestjs-telescope/commit/8d9f88f0ef9653cf3e6cafdf47ceceecc4d2abef) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - The tag filter is a picker over what exists — searched and paged on the server
...
- [`80392f0`](https://github.com/DavideCarvalho/nestjs-telescope/commit/80392f0e4d038b50b5c8703275cfd91e3328064b) - Add NestJS 12 to the supported peer range.
...
- [#82](https://github.com/DavideCarvalho/nestjs-telescope/pull/82) [`d245d70`](https://github.com/DavideCarvalho/nestjs-telescope/commit/d245d7093fdb748fa398d6dd1c8b24d4110cbfbb) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Let a dashboard section declare `cols: 1` — the full-width row.
...
- [#57](https://github.com/DavideCarvalho/nestjs-telescope/pull/57) [`c9f264b`](https://github.com/DavideCarvalho/nestjs-telescope/commit/c9f264b3007859959d735a1bfdfe16f593f2b564) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Add an optional `dashboardAuth.revalidate` hook so a renewed dashboard session re-checks the user.
...
- [`579ac06`](https://github.com/DavideCarvalho/nestjs-telescope/commit/579ac069a42345866333216626556eae2cbd0e22) - Stop big component stacks from silently evicting client-exception enrichment (IP/geo/URL/user-agent), and add per-entry-type redaction budgets.
...
- [#50](https://github.com/DavideCarvalho/nestjs-telescope/pull/50) [`d11295d`](https://github.com/DavideCarvalho/nestjs-telescope/commit/d11295dbe5dfa15c246773e2819f43c2e1b5b3f8) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Richer exception alerts + a new `every-exception` rule.
...
- [`8af44cc`](https://github.com/DavideCarvalho/nestjs-telescope/commit/8af44ccc5aa1c189929406d2382319f02b6ce591) - De-dupe the `/meta` watcher list. An extension that ships a watcher whose `type` equals its declared
...
- [`d5a282e`](https://github.com/DavideCarvalho/nestjs-telescope/commit/d5a282ebc240a30ea2ee2a62059fe538ba73da83) - Bound binary payloads (Buffer/TypedArray/DataView/ArrayBuffer) in `redact()`
...
- [`0d1f7ae`](https://github.com/DavideCarvalho/nestjs-telescope/commit/0d1f7ae2afe6b308b407eabc781f0a308a260d85) - Add observability export seams used by `@dudousxd/nestjs-telescope-otel`. The `Recorder` gains a best-effort `onRecorded(input)` hook fired at the top of `record()` — before pause/sampling — so a metrics consumer gets complete counts even under overload. The `TelescopeExtension` SPI gains optional `observeRecord(input)` / `observeFlush(entries)` hooks, and `ExtensionRegistry` fans every record and every stored flush out to them (`notifyRecord` / `notifyFlush`), each isolated so a misbehaving observer can never break capture or the flush. Existing behavior is unchanged when no extension uses the hooks.
...
- [#15](https://github.com/DavideCarvalho/nestjs-telescope/pull/15) [`ba7790b`](https://github.com/DavideCarvalho/nestjs-telescope/commit/ba7790bebc182cac47be8f9761b91bb85d16f20b) Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)! - Rich extension dashboards: the panel IR gains delta/sparkline/threshold on `stat`
